...
```spl
  ...
  (process="*ScheduledTask*" OR process="*TaskScheduler*")
  | table _time EventCode user process_name process_path process_id process parent_process_name parent_process_id 
  | sort - _time
```
...
- Atomic Red Team: https://www.atomicredteam.io/docs/atomics/T1053.005#atomic-test-6-wmi-invoke-cimmethod-scheduled-task